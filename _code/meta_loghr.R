...
# Soloist and Scored with divergent measure for HHF  
  ...
  df$hr <- ifelse((df$trialname == "SOLOIST-WHF"& df$outcome == "HospHeartFailure") 
                  |( df$trialname == "SCORED" & df$outcome == "HospHeartFailure"), NA, 
                  df$hr)
...
for(i in 1:length(outcomes)){
 ...
 if(rowsg<13){
  ...
  dev.off()
  lnames.g[[i]] <- paste0("~/Documents/_meta/_forest/meta_loghr_glp1_", outcomes[i],".png")
  lnames.s[[i]] <- paste0("~/Documents/_meta/_forest/meta_loghr_sglt2i_", outcomes[i],".png")
...
ggsave("/Users/josemariarodriguezvaladez/Documents/_meta/_figures/_revision2/Figure1.png",plot = p, dpi = 300, width =  12, height =  16)
...
ggsave("/Users/josemariarodriguezvaladez/Documents/_meta/_figures/_revision2/metahrall.png",plot = p2.1, dpi = 300, width =  12, height =  16)
ggsave("/Users/josemariarodriguezvaladez/Documents/_meta/_figures/_revision2/metahrstr.png",plot = p2.2, dpi = 300, width =  12, height =  16)
ggsave("/Users/josemariarodriguezvaladez/Documents/_meta/_figures/_revision2/metahrmi.png",plot = p2.3, dpi = 300, width =  12, height =  16)
